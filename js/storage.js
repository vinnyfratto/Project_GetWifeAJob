...
const Storage = (() => {
  const KEYS = {
    ...
    seeded:        "jt_seeded_v7",
    i35seeded:     "jt_i35seeded_v2",
    usseeded:      "jt_usseeded_v2",
  };
  ...
  function seed() {
    ...
    const companies = [
      { company:"Texas Health Resources", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.texashealth.org", contact:"", notes:"✅ Actively hiring June 2026. One of the top TX employers for remote coders — confirmed open reqs on Indeed and Glassdoor. Outpatient and inpatient roles. Avg $20/hr." },
      { company:"Harris Health System", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.harrishealth.org/careers", contact:"", notes:"Houston-area public health system. Outpatient Coder III roles confirmed active on Glassdoor (June 2026). E&M and procedure coding focus. AAPC cert required." },
      { company:"Cook Children's", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.cookchildrens.org", contact:"", notes:"✅ Confirmed hiring June 2026 per Indeed/Glassdoor. Fort Worth pediatric system. Outpatient Coding Specialist roles open. Pediatric coding experience a plus." },
      ...
      { company:"Vee Healthtek", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.veehealthtek.com/careers", contact:"", notes:"100% remote coding company. Diagnostic Radiology Coder roles recurringly posted. Very high fit for radiology background. Check careers page regularly — roles fill fast." },
      { company:"Greenberg & Larraby", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.greenberglarraby.com/careers", contact:"", notes:"Radiology billing and coding firm in TX. High specialty fit for radiology background. Small team, personalized culture. Check careers page directly for openings." },
      ...
      { company:"Texas Children's Hospital", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://jobs.texaschildrens.org", contact:"", notes:"Premier pediatric system in Houston. Large HIM coding team. Remote outpatient coding roles posted regularly. Strong benefits and mission-driven culture." },
      { company:"University Health", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.universityhealthsystem.com/careers", contact:"", notes:"✅ Confirmed active June 2026 — appeared in SA-area coder search results. San Antonio public health system. Outpatient and specialty coder roles. Remote-friendly." },
      ...
      { company:"Houston Methodist", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.houstonmethodist.org", contact:"", notes:"Major Houston academic health system. Centralized HIM coding team. Remote coder roles posted across multiple specialties. Competitive pay and strong reputation." },
      { company:"Parkland Health", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.phhs.org", contact:"", notes:"Dallas County public hospital — one of the busiest in TX. Active remote coding program. Public-sector stability with good pay and benefits. Outpatient multi-specialty roles." },
      { company:"UTHealth Houston", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://jobs.uth.tmc.edu", contact:"", notes:"UT Health Science Center Houston physician practices. Outpatient, E&M, and specialty coding. Remote roles available for experienced coders. TMC affiliation = strong growth." },
      { company:"Children's Health (Dallas)", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.childrens.com", contact:"", notes:"Children's Medical Center Dallas — large pediatric system with significant HIM team. Remote outpatient coding roles posted regularly. Great benefits and culture." },
      { company:"JPS Health Network", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.jpshealthnet.org", contact:"", notes:"Tarrant County (Fort Worth) public health system. Outpatient multi-specialty coding. Stable public-sector employment. Good pay scale and benefits package." },
      { company:"Tenet Healthcare", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.tenethealth.com", contact:"", notes:"✅ Tenet Practice Resources confirmed active in SA market June 2026. Dallas-based national system. Central remote coding hub. Large-system stability and growth path." },
      { company:"Kelsey-Seybold Clinic", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.kelsey-seybold.com/about-kelsey-seybold-clinic/careers", contact:"", notes:"One of Houston's largest multi-specialty physician groups. Outpatient coding and E&M focus. Good remote flexibility for experienced coders. Well-regarded employer." },
      ...
      { company:"WellMed Medical Management", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.wellmed.com/careers", contact:"", notes:"San Antonio physician group (UnitedHealth Group). Medicare/senior patient focus = risk-adjustment coding demand. Outpatient remote roles. UHG benefits package." },
      ...
      { company:"Texas Oncology", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.texasoncology.com/about-us/careers", contact:"", notes:"Largest community oncology network in TX. Codes chemo admin, E&M, surgical oncology. Remote coding roles posted. Specialty background is a strong differentiator here." },
      ...
      { company:"Covenant Health (Lubbock)", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.covenanthealthlubbock.com/careers", contact:"", notes:"West TX regional system (Providence/St. Joseph). Outpatient and inpatient coding. Remote options for experienced coders. Good stability in the Lubbock market." },
      ...
      { company:"Kindred Healthcare", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://careers.kindredhealthcare.com", contact:"", notes:"Long-term acute care and rehab hospitals with significant TX operations. Post-acute coding is a specialty niche — strong differentiator. Remote inpatient coding roles." },
    ];
  ...
  function seedI35() {
    ...
    const i35 = [
      // ── San Antonio ──────────────────────────────────────────────────────────
      { company:"University Health",                  city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.universityhealthsystem.com/careers",         notes:"✅ Confirmed active June 2026 in SA coder search results. Large Bexar County public system. Inpatient, outpatient, and ED coding roles. Good public-sector benefits.", status:"New" },
      ...
      { company:"Methodist Healthcare (HCA)",         city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.sahealth.com/careers",                       notes:"✅ Parallon (HCA's RCM arm) confirmed active in SA market June 2026. Multi-hospital SA system. Strong remote HIM program. Hires experienced coders regularly.", status:"New" },
      ...
      { company:"UT Health San Antonio",              city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://jobs.uthscsa.edu",                               notes:"Academic medical center and large physician group. Multi-specialty coding across many departments. Remote-friendly for experienced coders. Competitive academic pay.", status:"New" },
      ...
      { company:"Southwest General Hospital",         city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.swgeneralhospital.com/careers",              notes:"Community hospital in SW San Antonio. Smaller HIM team — experienced coders stand out. Outpatient coding focus. Growing remote flexibility.", status:"New" },
      { company:"Post Acute Medical",                 city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.postacutemedical.com/careers",               notes:"LTACH and rehab facilities in SA. Specialty post-acute coding niche. LTACH coding experience is a differentiator. Remote roles available for qualified coders.", status:"New" },
      { company:"CommuniCare Health Centers",         city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.communicarehc.org/careers",                 notes:"FQHC serving SA underserved communities. Outpatient multi-specialty coding and billing roles. Mission-driven and stable. Good fit for outpatient coders.", status:"New" },
      { company:"ECLAT Health Solutions",             city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.eclathealthsolutions.com/careers",           notes:"✅ Confirmed active in SA coder search June 2026. Medical coding and billing company with SA presence. Remote coding roles. Hires certified coders directly.", status:"New" },
      // ── New Braunfels ────────────────────────────────────────────────────────
      ...
      { company:"Resolute Health Hospital",           city:"New Braunfels", state:"TX", remote_friendly:"Yes", careerPage:"https://www.resolutehealth.com/careers",               notes:"Community hospital in New Braunfels. Smaller coding team — experienced coders get noticed. Good for outpatient and ED coding. Growing I-35 corridor facility.", status:"New" },
      // ── San Marcos ───────────────────────────────────────────────────────────
      { company:"Ascension Seton Hays – San Marcos",  city:"San Marcos",   state:"TX", remote_friendly:"Yes", careerPage:"https://healthcare.ascension.org/careers",             notes:"Ascension system hospital serving Hays County. Remote coding roles posted through Ascension's central HIM team. Fast-growing area with expanding coding needs.", status:"New" },
      { company:"Central Texas Medical Center",       city:"San Marcos",   state:"TX", remote_friendly:"Yes", careerPage:"https://www.ctmc.org/careers",                         notes:"Independent community hospital in San Marcos. Active HIM department. Good for outpatient and inpatient coding. Smaller team with stable community focus.", status:"New" },
      // ── Kyle / Buda ──────────────────────────────────────────────────────────
      { company:"Ascension Seton Hays – Kyle",        city:"Kyle",         state:"TX", remote_friendly:"Yes", careerPage:"https://healthcare.ascension.org/careers",             notes:"Rapidly growing Ascension hospital in Kyle serving the booming Hays County population. Central Ascension remote coding roles. High-growth corridor.", status:"New" },
      { company:"Kyle Regional Medical Center",       city:"Kyle",         state:"TX", remote_friendly:"Yes", careerPage:"https://www.stewardhealth.org/careers",                notes:"Community hospital in Kyle serving the Kyle-Buda growth corridor. Outpatient and inpatient coding roles. Growing facility with increasing remote flexibility.", status:"New" },
      // ── Austin ───────────────────────────────────────────────────────────────
      { company:"St. David's HealthCare",             city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://stdavids.com/careers",                         notes:"✅ HCA-affiliated multi-hospital Austin system. Parallon (HCA RCM) posts remote coder roles continuously. Strong remote HIM program. Multiple specialty reqs.", status:"New" },
      { company:"Ascension Seton (Austin)",           city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://healthcare.ascension.org/careers",             notes:"Major nonprofit Austin health system. Large HIM and coding department. Remote-friendly for experienced coders. Multiple Austin-area facilities.", status:"New" },
      { company:"Dell Seton Medical Center (UT)",     city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://jobs.utsouthwestern.edu",                      notes:"UT academic medical center in Austin. Complex multi-specialty coding environment. Strong career growth. Competitive pay for experienced coders.", status:"New" },
      { company:"Austin Regional Clinic (ARC)",       city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://www.austinregionalclinic.com/careers",         notes:"Largest physician group in Austin. Outpatient multi-specialty coding and billing. Good work-life balance reputation. Hires coders and billers regularly.", status:"New" },
      { company:"Dell Children's Medical Center",     city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://healthcare.ascension.org/careers",             notes:"Pediatric hospital in Austin under Ascension. Specialty pediatric coding. Remote roles available through Ascension system. Growing pediatric coding team.", status:"New" },
      { company:"CommunityCare (FQHC – Austin)",      city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://www.communitycaretx.org/careers",             notes:"FQHC serving Austin underserved communities. Outpatient multi-specialty coding and billing. Mission-driven employer with stable funding and good culture.", status:"New" },
      ...
      { company:"UT Health Austin",                   city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://jobs.utsouthwestern.edu",                      notes:"UT multispecialty physician practice in Austin. Growing outpatient coding team. Competitive academic pay scale. Good fit for outpatient multi-specialty coders.", status:"New" },
    ];
  ...
  function seedUS() {
    ...
    const us = [
      // ── Midwest ──────────────────────────────────────────────────────────────
      { company:"Mayo Clinic",                      state:"MN", remote_friendly:"Yes", careerPage:"https://jobs.mayoclinic.org",                notes:"✅ Remote jobs page confirmed active June 2026 at jobs.mayoclinic.org/Remote. World-renowned academic system. Large HIM/coding team. Top-tier pay and benefits.", status:"New" },
      ...
      { company:"Northwestern Medicine",            state:"IL", remote_friendly:"Yes", careerPage:"https://www.nm.org/about/careers",            notes:"Chicago academic health system. Large HIM department. Remote coding roles for experienced coders. Multi-specialty including outpatient and complex inpatient.", status:"New" },
      ...
      { company:"OSF HealthCare",                   state:"IL", remote_friendly:"Yes", careerPage:"https://www.osfhealthcare.org/careers",       notes:"Catholic system across IL and MI. Remote coding roles. Outpatient multi-specialty and inpatient coding. Strong mission-driven culture and good benefits.", status:"New" },
      { company:"UnityPoint Health",                state:"IA", remote_friendly:"Yes", careerPage:"https://jobs.unitypoint.org",                 notes:"Regional system across IA, IL, WI. Centralized coding team. Remote roles for outpatient and inpatient coders. Good stability in a community-focused system.", status:"New" },
      { company:"SSM Health",                       state:"MO", remote_friendly:"Yes", careerPage:"https://www.ssmhealth.com/careers",           notes:"Catholic nonprofit across MO, IL, WI, OK. Remote HIM and coding roles. Multi-specialty outpatient focus. Stable system with strong benefits.", status:"New" },
      { company:"BJC HealthCare",                   state:"MO", remote_friendly:"Yes", careerPage:"https://www.bjc.org/careers",                 notes:"Major St. Louis health system (Barnes-Jewish, Wash U affiliation). Large centralized coding team. Remote coding roles posted regularly. Competitive pay.", status:"New" },
      { company:"Mercy Health System",              state:"MO", remote_friendly:"Yes", careerPage:"https://www.mercy.net/careers",               notes:"Large Catholic system across MO, AR, KS, OK. Remote HIM coders hired regularly. Outpatient and inpatient roles. Strong tech-forward HIM environment.", status:"New" },
      ...
      { company:"Henry Ford Health",                state:"MI", remote_friendly:"Yes", careerPage:"https://careers.henryford.com",               notes:"Detroit-based integrated health system. Large HIM department. Remote coding roles for experienced coders. Multi-specialty and outpatient focus.", status:"New" },
      { company:"Trinity Health",                   state:"MI", remote_friendly:"Yes", careerPage:"https://www.trinity-health.org/careers",      notes:"National Catholic system (HQ in MI) with 100+ hospitals. Remote coding roles across many facilities. Excellent benefits and job stability nationwide.", status:"New" },
      { company:"Indiana University Health",        state:"IN", remote_friendly:"Yes", careerPage:"https://iuhealth.org/careers",                notes:"Indiana's largest health system. Strong HIM department. Remote outpatient and inpatient coding. Academic affiliation means complex, high-value coding experience.", status:"New" },
      ...
      { company:"Bon Secours Mercy Health",         state:"OH", remote_friendly:"Yes", careerPage:"https://jobs.bsmhealth.com",                  notes:"Large Catholic system across OH, KY, VA and beyond. Remote HIM coding roles. Multi-specialty and outpatient focus. Stable national employer.", status:"New" },
      ...
      { company:"Nationwide Children's Hospital",   state:"OH", remote_friendly:"Yes", careerPage:"https://careers.nationwidechildrens.org",    notes:"Top-ranked pediatric hospital in Columbus. Remote pediatric coding roles. Complex specialty coding. One of the most respected children's hospitals in the US.", status:"New" },
      ...
      { company:"Sanford Health",                   state:"SD", remote_friendly:"Yes", careerPage:"https://careers.sanfordhealth.org",           notes:"Large rural system across SD, ND, MN. Remote coding roles regularly posted. Multi-specialty outpatient focus. Very stable employer in a less competitive market.", status:"New" },
      // ── Northeast ────────────────────────────────────────────────────────────
      { company:"Mass General Brigham",             state:"MA", remote_friendly:"Yes", careerPage:"https://careers.massgeneralbrigham.org",      notes:"Leading academic system (MGH + Brigham & Women's). Large HIM team. Remote coding roles for experienced coders. Top-tier compensation and prestige.", status:"New" },
      { company:"Boston Children's Hospital",       state:"MA", remote_friendly:"Yes", careerPage:"https://careers.childrenshospital.org",       notes:"#1-ranked US children's hospital. Remote pediatric coding roles. Complex specialty coding. Excellent reputation and competitive pay for coding staff.", status:"New" },
      { company:"Yale New Haven Health",            state:"CT", remote_friendly:"Yes", careerPage:"https://careers.ynhhs.org",                   notes:"Yale-affiliated academic system in CT. Remote coding roles for outpatient and inpatient. Strong HIM department. Competitive pay in a high-cost market.", status:"New" },
      { company:"Hartford HealthCare",              state:"CT", remote_friendly:"Yes", careerPage:"https://jobs.hartfordhealthcare.org",          notes:"Largest health system in CT. Centralized HIM team. Remote coding roles for outpatient and inpatient specialties. Good benefits and career growth.", status:"New" },
      ...
      { company:"Johns Hopkins Medicine",           state:"MD", remote_friendly:"Yes", careerPage:"https://careers.hopkinsmedicine.org",         notes:"World-renowned academic medical center in Baltimore. Remote coding roles for experienced coders. High-complexity multi-specialty cases. Top-tier compensation.", status:"New" },
      { company:"Sentara Healthcare",               state:"VA", remote_friendly:"Yes", careerPage:"https://www.sentara.com/careers",             notes:"✅ Confirmed hiring in national coder search results June 2026. Large system across VA and NC. Remote HIM coding roles. Multi-specialty outpatient and inpatient.", status:"New" },
      ...
      { company:"WVU Medicine",                     state:"WV", remote_friendly:"Yes", careerPage:"https://careers.wvumedicine.org",             notes:"Academic health system in WV. Remote coding roles available. Multi-specialty outpatient and inpatient focus. Less competitive market — strong candidates stand out.", status:"New" },
      // ── Southeast ────────────────────────────────────────────────────────────
      { company:"Vanderbilt University Medical Center", state:"TN", remote_friendly:"Yes", careerPage:"https://careers.vumc.org",               notes:"Top academic medical center in Nashville. Large HIM team. Remote coding roles across complex multi-specialty cases. Nationally ranked. Strong pay and growth.", status:"New" },
      ...
      { company:"Lifepoint Health",                 state:"TN", remote_friendly:"Yes", careerPage:"https://jobs.lifepointhealth.com",            notes:"National hospital company based in TN. Remote HIM coding roles across many facilities nationwide. Outpatient and inpatient coding. Large-system career growth.", status:"New" },
      { company:"Emory Healthcare",                 state:"GA", remote_friendly:"Yes", careerPage:"https://careers.emoryhealthcare.org",         notes:"Academic health system in Atlanta. Large HIM department. Remote coding roles for experienced coders. Multi-specialty including complex academic cases.", status:"New" },
      ...
      { company:"Piedmont Healthcare",              state:"GA", remote_friendly:"Yes", careerPage:"https://careers.piedmont.org",                notes:"Large Atlanta-based nonprofit. Remote HIM coding roles. Multi-specialty outpatient and inpatient coding. Fast-growing system with good benefits.", status:"New" },
      ...
      { company:"Novant Health",                    state:"NC", remote_friendly:"Yes", careerPage:"https://www.novanthealth.org/careers",         notes:"Large nonprofit across NC, SC, VA. Remote coding roles posted regularly. Multi-specialty outpatient and inpatient focus. Good culture and benefits.", status:"New" },
      ...
      { company:"MUSC Health",                      state:"SC", remote_friendly:"Yes", careerPage:"https://careers.musc.edu",                    notes:"Academic medical center in Charleston SC. Remote coding roles for experienced coders. Multi-specialty focus. Historic academic system with competitive pay.", status:"New" },
      { company:"UAB Health System",                state:"AL", remote_friendly:"Yes", careerPage:"https://www.uab.edu/jobs",                    notes:"Academic medical center in Birmingham. Large HIM team. Remote coding roles across multiple specialties. Nationally ranked NCI cancer center = specialty coding depth.", status:"New" },
      ...
      { company:"Baptist Health (Louisville)",      state:"KY", remote_friendly:"Yes", careerPage:"https://careers.baptisthealth.com",            notes:"Large health system across KY. Remote HIM coding roles. Outpatient and inpatient multi-specialty coding. Stable faith-based employer with good benefits.", status:"New" },
      { company:"AdventHealth",                     state:"FL", remote_friendly:"Yes", careerPage:"https://careers.adventhealth.com",            notes:"Large faith-based system headquartered in FL with national presence. Remote coding roles. Multi-specialty outpatient and inpatient. Strong mission-driven culture.", status:"New" },
      ...
      { company:"BayCare Health System",            state:"FL", remote_friendly:"Yes", careerPage:"https://careers.baycare.org",                 notes:"Large nonprofit in Tampa Bay area. Remote coding roles for outpatient and inpatient specialties. Competitive benefits and strong regional reputation.", status:"New" },
      { company:"UF Health",                        state:"FL", remote_friendly:"Yes", careerPage:"https://hr.ufhealth.org/careers",             notes:"Academic health system at University of Florida. Remote coding roles. Multi-specialty and outpatient coding focus. Academic affiliation = high-complexity coding.", status:"New" },
      // ── West ─────────────────────────────────────────────────────────────────
      { company:"Kaiser Permanente",                state:"CA", remote_friendly:"Yes", careerPage:"https://jobs.kaiserpermanente.org",           notes:"✅ Massive integrated health plan with dedicated coder hiring. Large HIM/coding team. Remote coding roles across multiple regions. Excellent pay and benefits.", status:"New" },
      { company:"Cedars-Sinai Medical Center",      state:"CA", remote_friendly:"Yes", careerPage:"https://jobs.cedars-sinai.edu",              notes:"Top LA academic medical center. Remote coding roles for experienced coders. High-complexity multi-specialty cases. Top-tier pay in a high-cost market.", status:"New" },
      { company:"UCLA Health",                      state:"CA", remote_friendly:"Yes", careerPage:"https://careers.uclahealth.org",             notes:"Major academic health system in LA. Remote coding roles for outpatient and inpatient. Multi-specialty and complex case focus. University of CA pay scale.", status:"New" },
      { company:"Sutter Health",                    state:"CA", remote_friendly:"Yes", careerPage:"https://www.sutterhealth.org/careers",        notes:"Large nonprofit in Northern CA. Remote HIM coding roles. Outpatient and inpatient multi-specialty coding. One of the largest CA employers for coders.", status:"New" },
      { company:"Scripps Health",                   state:"CA", remote_friendly:"Yes", careerPage:"https://www.scripps.org/careers",            notes:"San Diego-based nonprofit. Remote coding roles available. Multi-specialty outpatient and inpatient coding. Well-regarded employer in the San Diego market.", status:"New" },
      ...
      { company:"UCHealth",                         state:"CO", remote_friendly:"Yes", careerPage:"https://www.uchealth.org/careers",           notes:"Academic health system in CO (U of Colorado affiliation). Remote coding roles. Multi-specialty outpatient and inpatient. Competitive pay in a growing market.", status:"New" },
      { company:"Providence Health & Services",     state:"WA", remote_friendly:"Yes", careerPage:"https://jobs.providence.org",                notes:"Large Catholic system (WA, OR, CA, MT, AK). Remote HIM coding roles. Multi-specialty and outpatient coding. Excellent benefits and nationwide footprint.", status:"New" },
      { company:"MultiCare Health System",          state:"WA", remote_friendly:"Yes", careerPage:"https://www.multicare.org/careers",          notes:"WA-based nonprofit health system serving Puget Sound area. Remote coding roles for outpatient and inpatient. Good benefits and stable community-based employer.", status:"New" },
      { company:"Seattle Children's Hospital",      state:"WA", remote_friendly:"Yes", careerPage:"https://jobs.seattlechildrens.org",          notes:"Top-ranked pediatric hospital in the Pacific Northwest. Remote pediatric coding roles. Specialty coding for complex pediatric cases. Excellent pay and culture.", status:"New" },
      ...
      { company:"PeaceHealth",                      state:"WA", remote_friendly:"Yes", careerPage:"https://www.peacehealth.org/careers",        notes:"Catholic system across WA, OR, AK. Remote HIM coding roles. Outpatient and inpatient multi-specialty coding. Mission-driven culture and stable employment.", status:"New" },
      { company:"St. Luke's Health System",         state:"ID", remote_friendly:"Yes", careerPage:"https://careers.stlukesonline.org",          notes:"Largest health system in ID. Remote coding roles available. Multi-specialty outpatient and inpatient. Less competitive market — strong candidates stand out.", status:"New" },
      { company:"Banner Health",                    state:"AZ", remote_friendly:"Yes", careerPage:"https://careers.bannerhealth.com",           notes:"Large nonprofit across AZ and western states. Remote HIM coding roles regularly posted. Multi-specialty coding. One of the largest AZ employers for coders.", status:"New" },
      { company:"CommonSpirit Health",              state:"CO", remote_friendly:"Yes", careerPage:"https://www.commonspirit.careers/employment/remote-medical-coding-jobs/35300/8230896/1000000000100/2", notes:"✅ Dedicated remote medical coding jobs page confirmed active June 2026. National nonprofit with facilities in 24 states. Apply direct at commonspirit.careers.", status:"New" },
