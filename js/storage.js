...
const Storage = (() => {
  const KEYS = {
    ...
    seeded:        "jt_seeded_v8",
    i35seeded:     "jt_i35seeded_v3",
    usseeded:      "jt_usseeded_v3",
  };
  ...
  function seedI35() {
    ...
    const i35 = [
      ...
      { company:"UT Health San Antonio",              city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://jobs.uthscsa.edu",                               notes:"✅ Hybrid coder role confirmed open July 2026 (remote plus on-campus, must live within commuting distance). Academic medical center and large physician group. Multi-specialty coding. Competitive academic pay.", status:"New" },
  ...
  function seedUS() {
    ...
    const us = [
      ...
      { company:"iMedX",                            state:"GA", remote_friendly:"Yes", careerPage:"https://www.imedx.com/careers", notes:"Atlanta-based remote medical coding company. Hires certified coders as employees or contractors. Requires 3+ years experience. Serves hospitals and provider groups nationwide.", status:"New" },
