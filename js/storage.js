...
const Storage = (() => {
  ...
  function seed() {
    ...
    const companies = [
      ...
      { company:"University Health", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.universityhealth.com/careers", contact:"", notes:"✅ Confirmed active June 2026 — appeared in SA-area coder search results. San Antonio public health system. Outpatient and specialty coder roles. Remote-friendly." },
      ...
      { company:"Parkland Health", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://parklandcareers.com", contact:"", notes:"Dallas County public hospital — one of the busiest in TX. Active remote coding program. Public-sector stability with good pay and benefits. Outpatient multi-specialty roles." },
  ...
  function seedI35() {
    ...
    const i35 = [
      // ── San Antonio ──────────────────────────────────────────────────────────
      { company:"University Health",                  city:"San Antonio", state:"TX", remote_friendly:"Yes", careerPage:"https://www.universityhealth.com/careers",         notes:"✅ Confirmed active June 2026 in SA coder search results. Large Bexar County public system. Inpatient, outpatient, and ED coding roles. Good public-sector benefits.", status:"New" },
      ...
      { company:"UT Health Austin",                   city:"Austin",       state:"TX", remote_friendly:"Yes", careerPage:"https://uthealthaustin.org/careers",                   notes:"UT Austin / Dell Medical School physician practice (not UT Southwestern). Outpatient coding and billing roles. Growing academic practice, competitive pay.", status:"New" },
    ];
  ...
  function seedUS() {
    ...
    const us = [
      ...
      { company:"UF Health",                        state:"FL", remote_friendly:"Yes", careerPage:"https://jobs.ufhealth.org/jobs",             notes:"Academic health system at University of Florida. Remote coding roles. Multi-specialty and outpatient coding focus. Academic affiliation = high-complexity coding.", status:"New" },
      // ── West ─────────────────────────────────────────────────────────────────
