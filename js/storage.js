...
const Storage = (() => {
  ...
  function seed() {
    ...
    const companies = [
      ...
      { company:"Ascension Texas", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://jobs.ascension.org/us/en/remote", contact:"", notes:"Catholic nonprofit with 14 TX hospitals. Central HIM coding team posts remote outpatient and specialty coder roles regularly. Good stability and benefits." },
      ...
      { company:"Texas Tech Physicians", state:"TX", remote_friendly:"Yes", target:"Yes", priority:"High", careerPage:"https://www.ttuhsc.edu/jobs/default.aspx", contact:"", notes:"Academic physician group for TTUHSC. Multi-specialty outpatient coding across West TX campuses (Lubbock, Amarillo, El Paso). Remote roles available for experienced coders." },
  ...
  function seedUS() {
    ...
    const us = [
      ...
      { company:"Emory Healthcare",                 state:"GA", remote_friendly:"Yes", careerPage:"https://www.emoryhealthcare.org/careers",         notes:"Academic health system in Atlanta. Large HIM department. Remote coding roles for experienced coders. Multi-specialty including complex academic cases.", status:"New" },
